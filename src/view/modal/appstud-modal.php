<div class="modal-header">
    <h6 class="modal-title">Application Status Update: <strong>#{{appinfo.aplid}}</strong> <img src="src/assets/images/email.gif" alt="Loading..." width="32" ng-show="emailoading"></h6>
        ...
        <div class="col-lg-12 px-4">
            ...
            <div class="my-3">
                ...
                <select class="form-input" ng-model="appinfo.aplstatus">
                    <option ng-value="6" ng-disabled>Open Application</option>
                    ...
                    <option ng-value="3" ng-disabled="appinfo.aplstatus !== 5 && appinfo.aplstatus > 3">Approved</option>
                    <option ng-value="4" ng-disabled="appinfo.aplstatus !== 5 && appinfo.aplstatus > 4 ">Rejected</option>
                    <option ng-value="5" ng-disabled="appinfo.aplstatus > 5 || appinfo.aplstatus == 4">Hold</option>
                </select>
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-sms-save" ng-click="application_status(appinfo, appinfo.aplstatus)" ng-disabled="checkstudapp == 1 || appinfo.aplstatus == 6">Update</button>
</div>