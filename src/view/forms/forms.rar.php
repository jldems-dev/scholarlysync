<h1 class="mt-4">Rules and Regulations Agreement <img src="src/assets/images/email.gif" alt="Loading..." width="32" ng-show="emailoading"></h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Manage Rules and Regulations Agreement</li>
</ol>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="filter">
                <div class="d-flex align-items-center justify-content-end w-100 gap-2">
                    <div class="d-flex align-items-center justify-content-end gap-2">
                        <button type="button" class="btn btn-sms-save " ng-click="forms_update(1, forms)" >Save</button>
            ...
            <div class="filter">
                <div class="d-flex align-items-center justify-content-end w-100 gap-2">
                    <div class="d-flex align-items-center justify-content-start">
                        <button type="button" class="btn btn-sms-save" ng-click="show_modal('studlist' , 2)">Select Student</button>
                    </div>
                    <div class="d-flex align-items-center justify-content-end gap-2">
                        <button type="button" class="btn btn-sms-second " ng-click="send_forms(rar)" >Sent Email</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="table-css">
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <tr ng-if="rar.userid != 0">
                            <td>{{rar.sfid}}</td>
                            <td>{{rar.sfdate | date:'MMM dd, yyyy'}}</td>
                            <td>{{rar.usernum}}</td>
                            <td>{{rar.fname}} {{rar.mname? rar.mname + '.' : ''}} {{rar.lname}}</td>
                            <td>{{sfstatus(rar.sfstatus)}}</td>
                            <td width="8%">
                                <div class="d-flex align-items-center justify-content-center gap-3">
                                    <a type="button" ng-click="studform_delete(rar.sfid)"><i class="fa-solid fa-ban text-danger"></i></a>
                                </div>
                            </td>
                        </tr>
                        <tr ng-if="rar.userid == 0">
                            <td colspan="6" class="text-center">Select Student to Sent Contact</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-12">
            <div class="table-css">
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <tr ng-repeat="sf in filtered = (sflist | filter: {formtype: 2} | filter: search) | limitTo:items_per_page:items_per_page*(current_page-1)">
                            <td>{{sf.sfid}}</td>
...
<?php include "../print/rar_print.php" ?>